...
public class Ninja : MonoBehaviour {
	...
	void Start () {
		...
		localScale = transform.localScale; //transforming the localstate of the charcter to left and right.
	...
	void Update () {		
        ...
        //logic for running,jumping
		if (Mathf.Abs(dirX) > 0 && rb.velocity.y == 0 ) // if the dirX > 0 and dirY == 0 
		// make running animtion true else false. depends on the direction of Y AND X.
